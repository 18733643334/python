...
class ReadExcel:
    def __init__(self):
        ...
        self.project_name = ''
        self.project_re = {
            'XYL': '^[a-z]{3}_[a-z]{3}_[a-zA-Z]+_[0-9]{3}shotInfo_v[0-9]{4}.xl',
            'MOB': '^[a-z]{3}_[a-z]{3}_[a-zA-Z]+_[0-9]{3}shotInfo_v[0-9]{4}-[0-9]{8}.xl'
        }

    def set_file(self):
        self.file_path = '/Users/shihongxiao/Desktop/All/%s/Doc/shot/' % self.project_name
        self.save_path = '/Users/shihongxiao/Desktop/All/%s/References/tmp' % self.project_name
        ...
        if file_names:
            for file in file_names:
                ...
                if extension in extensions:
                    re_str1 = self.project_re[self.project_name]
    ...
    def set_column_link(self):
        ...
        for d in self.new_data:
            field = d[0]
            r = self.project_re[self.project_name].replace('^', '')
            rr = "^%s%s" % (self.file_path, r)
            rrr = rr.replace('_[0-9]{3}', '_' + field)
